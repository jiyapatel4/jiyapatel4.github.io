...
To conclude, the main idea of this chapter was to introduce the concepts of virtualizing resources such as the CPU, memory, and disk, the strange behaviour of concurrency and atomic instructions, and the reliable persistence of data. All in the hopes of making the system easy to use, while balancing real-world trade-offs, constraints, and the siren’s song of perfection.